"""
Generate large CSV files for MySQL LOAD DATA experiments.

The generated rows are synthetic. They do not contain real student IDs,
student names, enrollment records, or grades. Public JNU department data can be
loaded separately with sql/jnu_public_seed.sql.
"""
...
def enrollment_rows():
    # 10,000 students x first 5 generated lectures = 50,000 unique pairs.
